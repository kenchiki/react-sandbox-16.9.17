...
export enum PetStatus { Free, Delivery }
...
export default class Pet {
  ...
  public petStatus: PetStatus = PetStatus.Free;
  ...
  public listenDelivery () {
    return new Promise((resolve) => {
      this.step = 0
      this.petStatus = PetStatus.Delivery
